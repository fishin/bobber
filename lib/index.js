...
exports.checkoutCode = function(path, scm, pr) {
    ...
    var finishTime;
    commandResults.push(smelt.runCommand('git config --global user.name lloydbenson'));
    commandResults.push(smelt.runCommand('git config --global user.email lloyd.benson@gmail.com'));
