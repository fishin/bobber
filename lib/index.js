...
exports.checkoutCode = function(path, scm, pr) {
    ...
    var finishTime;
    //var simpleCommand = smelt.runCommand('git config --global push.default simple');
    var travisHack = smelt.runCommand('git config --global user.name ficion; git config --global user.email ficion@ficion.net');
