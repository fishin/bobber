...
module.exports = internals.Bobber = function (options) {
    ...
    this.getAllCommitsSync = exports.getAllCommitsSync;
    this.getCompareCommitsSync = exports.getCompareCommitsSync;
    this.getLatestCommitSync = exports.getLatestCommitSync;
    this.getLatestRemoteCommitSync = exports.getLatestRemoteCommitSync;
    this.getBranchesSync = exports.getBranchesSync;
    ...
    this.validateUrlSync = exports.validateUrlSync;
...
exports.checkoutCode = function (options, cb) {
    ...
    if (Fs.existsSync( gitPath )) {
        checkoutCommand = 'git pull origin ' + options.scm.branch;
    } else {
        checkoutCommand = 'git clone --branch=' + options.scm.branch + ' ' + options.scm.url + ' .';
    }
...
exports.getAllCommitsSync = function (path) {

    var smelt = new Smelt({ dirPath: path });
    var command = 'git log --pretty=format:"%H---%an---<%ae>---%ai---%s"';
    var result = smelt.runCommandSync({ command: command });
    var commits = internals.processCommits(result);
    return commits;
};

exports.getCompareCommitsSync = function (path, startCommit, endCommit) {
...
exports.getLatestCommitSync = function (path) {
...
exports.getLatestRemoteCommitSync = function (scm) {
...
exports.getBranchesSync = function (path) {
...
exports.validateUrlSync = function (scm) {
