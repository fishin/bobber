...
exports.getPullRequests = function(scm, cb) {
...
exports.getPullRequest = function (scm, number, cb) {
...
exports.mergePullRequest = function(scm, number, token, cb) {
    ...
    var mergePayload = {
        commit_message: 'Pull Request successfully merged'
    };
    ...
    internals.checkApiRateLimit(scm, function(payload) {
        ...
        if (payload.rate.remaining === 0) {
            ...
            Wreck.put(url, { options: options , payload: Wreck.toReadableStream(mergePayload) }, function(err, res, payload) {
