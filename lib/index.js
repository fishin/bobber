...
exports.checkoutCode = function(path, scm, pr) {
    ...
    var finishTime;
    commandResults.push(smelt.runCommand('git config user.name lloydbenson'));
    commandResults.push(smelt.runCommand('git config user.email lloyd.benson@gmail.com'));
